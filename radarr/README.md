...
5. Go to `Settings` > `Providers` and add some subtitle providers (some of them may lequire authentication). I chose: Napisy24, Napiprojekt, Opensubtitles.com, Subdl.